...
object SyncWebSocket : WebComponent<Nothing>, dev.outerstellar.platform.service.EventPublisher {
    ...
    var userRepository: dev.outerstellar.platform.security.UserRepository? = null
