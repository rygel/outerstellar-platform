...
data class ApiKeysPage(
    val title: String,
    val keys: List<dev.outerstellar.platform.model.ApiKeySummary>,
...
class WebPageFactory(
    ...
    private val securityService: dev.outerstellar.platform.security.SecurityService? = null,
    private val auditRepository: dev.outerstellar.platform.persistence.AuditRepository? = null,
    private val notificationService: dev.outerstellar.platform.service.NotificationService? = null,
) {
    ...
    fun buildConflictResolveModal(ctx: WebContext, syncId: String): ConflictResolveViewModel {
        val message =
            repository.findBySyncId(syncId)
                ?: throw dev.outerstellar.platform.model.MessageNotFoundException(syncId)
        val serverVersion =
