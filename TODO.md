...
- [ ] **Targeted cache invalidation in `MessageService`**
...
- [ ] **Bound the `gravatarCache` with Caffeine**
...
- [ ] **Eliminate extra SELECT in `JooqContactRepository.updateContact()`**
...
- [ ] **Continuous outbox drain when batch is full**
...
- [ ] **Document the jOOQ vs. JDBI persistence selection policy**
...
- [ ] **Guard `WebContext.user` against cache removal**
