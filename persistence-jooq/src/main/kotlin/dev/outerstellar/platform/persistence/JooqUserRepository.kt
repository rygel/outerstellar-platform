...
import dev.outerstellar.platform.jooq.tables.references.USERS
...
class JooqUserRepository(private val dsl: DSLContext) : UserRepository {
    ...
    private fun mapUser(record: dev.outerstellar.platform.jooq.tables.records.UsersRecord): User {
        return User(
            id = record.id!!,
