 ...
 */
package dev.outerstellar.platform.jooq.keys
...
import dev.outerstellar.platform.jooq.tables.records.ApiKeysRecord
...
import dev.outerstellar.platform.jooq.tables.records.FlywaySchemaHistoryRecord
import dev.outerstellar.platform.jooq.tables.records.MessagesRecord
import dev.outerstellar.platform.jooq.tables.records.NotificationsRecord
import dev.outerstellar.platform.jooq.tables.records.OauthConnectionsRecord
import dev.outerstellar.platform.jooq.tables.records.OutboxRecord
import dev.outerstellar.platform.jooq.tables.records.PasswordResetTokensRecord
import dev.outerstellar.platform.jooq.tables.records.SessionsRecord
import dev.outerstellar.platform.jooq.tables.records.SyncStateRecord
import dev.outerstellar.platform.jooq.tables.records.UsersRecord
...
val CONSTRAINT_6A: ForeignKey<ApiKeysRecord, UsersRecord> = Internal.createForeignKey(ApiKeys.API_KEYS, DSL.name("CONSTRAINT_6A"), arrayOf(ApiKeys.API_KEYS.USER_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_F: ForeignKey<ContactEmailsRecord, ContactsRecord> = Internal.createForeignKey(ContactEmails.CONTACT_EMAILS, DSL.name("CONSTRAINT_F"), arrayOf(ContactEmails.CONTACT_EMAILS.CONTACT_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_C, arrayOf(Contacts.CONTACTS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_3: ForeignKey<ContactPhonesRecord, ContactsRecord> = Internal.createForeignKey(ContactPhones.CONTACT_PHONES, DSL.name("CONSTRAINT_3"), arrayOf(ContactPhones.CONTACT_PHONES.CONTACT_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_C, arrayOf(Contacts.CONTACTS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_B: ForeignKey<ContactSocialsRecord, ContactsRecord> = Internal.createForeignKey(ContactSocials.CONTACT_SOCIALS, DSL.name("CONSTRAINT_B"), arrayOf(ContactSocials.CONTACT_SOCIALS.CONTACT_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_C, arrayOf(Contacts.CONTACTS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_1E5: ForeignKey<DeviceTokensRecord, UsersRecord> = Internal.createForeignKey(DeviceTokens.DEVICE_TOKENS, DSL.name("CONSTRAINT_1E5"), arrayOf(DeviceTokens.DEVICE_TOKENS.USER_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_59: ForeignKey<NotificationsRecord, UsersRecord> = Internal.createForeignKey(Notifications.NOTIFICATIONS, DSL.name("CONSTRAINT_59"), arrayOf(Notifications.NOTIFICATIONS.USER_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
...
val CONSTRAINT_86F0: ForeignKey<PasswordResetTokensRecord, UsersRecord> = Internal.createForeignKey(PasswordResetTokens.PASSWORD_RESET_TOKENS, DSL.name("CONSTRAINT_86F0"), arrayOf(PasswordResetTokens.PASSWORD_RESET_TOKENS.USER_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_826: ForeignKey<SessionsRecord, UsersRecord> = Internal.createForeignKey(Sessions.SESSIONS, DSL.name("CONSTRAINT_826"), arrayOf(Sessions.SESSIONS.USER_ID), dev.outerstellar.platform.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
