...
import dev.outerstellar.platform.jooq.indexes.IDX_MESSAGES_AUTHOR
import dev.outerstellar.platform.jooq.indexes.IDX_MESSAGES_CREATED
import dev.outerstellar.platform.jooq.indexes.IDX_MESSAGES_DELETED
import dev.outerstellar.platform.jooq.indexes.UX_MESSAGES_SYNC_ID
import dev.outerstellar.platform.jooq.keys.CONSTRAINT_1
...
open class Messages(
     ...
     */
    val SYNC_CONFLICT: TableField<MessagesRecord, String?> = createField(DSL.name("SYNC_CONFLICT"), SQLDataType.VARCHAR, this, "")
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_MESSAGES_AUTHOR, IDX_MESSAGES_CREATED, IDX_MESSAGES_DELETED, UX_MESSAGES_SYNC_ID)
