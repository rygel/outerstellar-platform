...
import dev.outerstellar.starter.jooq.tables.records.OauthConnectionsRecord
...
val CONSTRAINT_6A: ForeignKey<ApiKeysRecord, UsersRecord> = Internal.createForeignKey(ApiKeys.API_KEYS, DSL.name("CONSTRAINT_6A"), arrayOf(ApiKeys.API_KEYS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_F: ForeignKey<ContactEmailsRecord, ContactsRecord> = Internal.createForeignKey(ContactEmails.CONTACT_EMAILS, DSL.name("CONSTRAINT_F"), arrayOf(ContactEmails.CONTACT_EMAILS.CONTACT_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_C, arrayOf(Contacts.CONTACTS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_3: ForeignKey<ContactPhonesRecord, ContactsRecord> = Internal.createForeignKey(ContactPhones.CONTACT_PHONES, DSL.name("CONSTRAINT_3"), arrayOf(ContactPhones.CONTACT_PHONES.CONTACT_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_C, arrayOf(Contacts.CONTACTS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_B: ForeignKey<ContactSocialsRecord, ContactsRecord> = Internal.createForeignKey(ContactSocials.CONTACT_SOCIALS, DSL.name("CONSTRAINT_B"), arrayOf(ContactSocials.CONTACT_SOCIALS.CONTACT_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_C, arrayOf(Contacts.CONTACTS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val CONSTRAINT_1E5: ForeignKey<DeviceTokensRecord, UsersRecord> = Internal.createForeignKey(DeviceTokens.DEVICE_TOKENS, DSL.name("CONSTRAINT_1E5"), arrayOf(DeviceTokens.DEVICE_TOKENS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
...
val CONSTRAINT_826: ForeignKey<SessionsRecord, UsersRecord> = Internal.createForeignKey(Sessions.SESSIONS, DSL.name("CONSTRAINT_826"), arrayOf(Sessions.SESSIONS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
