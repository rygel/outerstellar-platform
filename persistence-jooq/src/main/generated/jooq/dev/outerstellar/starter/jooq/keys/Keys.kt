...
val CONSTRAINT_6A: ForeignKey<ApiKeysRecord, UsersRecord> = Internal.createForeignKey(ApiKeys.API_KEYS, DSL.name("CONSTRAINT_6A"), arrayOf(ApiKeys.API_KEYS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true)
...
val CONSTRAINT_1E5: ForeignKey<DeviceTokensRecord, UsersRecord> = Internal.createForeignKey(DeviceTokens.DEVICE_TOKENS, DSL.name("CONSTRAINT_1E5"), arrayOf(DeviceTokens.DEVICE_TOKENS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true)
val CONSTRAINT_59: ForeignKey<NotificationsRecord, UsersRecord> = Internal.createForeignKey(Notifications.NOTIFICATIONS, DSL.name("CONSTRAINT_59"), arrayOf(Notifications.NOTIFICATIONS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true)
val CONSTRAINT_F3F: ForeignKey<OauthConnectionsRecord, UsersRecord> = Internal.createForeignKey(OauthConnections.OAUTH_CONNECTIONS, DSL.name("CONSTRAINT_F3F"), arrayOf(OauthConnections.OAUTH_CONNECTIONS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true)
val CONSTRAINT_86F0: ForeignKey<PasswordResetTokensRecord, UsersRecord> = Internal.createForeignKey(PasswordResetTokens.PASSWORD_RESET_TOKENS, DSL.name("CONSTRAINT_86F0"), arrayOf(PasswordResetTokens.PASSWORD_RESET_TOKENS.USER_ID), dev.outerstellar.starter.jooq.keys.CONSTRAINT_4, arrayOf(Users.USERS.ID), true)
