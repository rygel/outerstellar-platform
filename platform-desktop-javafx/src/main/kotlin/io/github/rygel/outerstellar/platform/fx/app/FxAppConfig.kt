...
data class FxAppConfig(
    ...
    companion object {
        fun fromEnvironment(environment: Map<String, String> = System.getenv()): FxAppConfig {
        ...
        private fun readResource(loader: Load, path: String): Map<String, Any>? {
            val stream = FxAppConfig::class.java.getResourceAsStream(path) ?: return null
            return try {
        ...
        private fun buildFromYaml(yaml: Map<String, Any>?, env: Map<String, String>): FxAppConfig {
            if (yaml == null) return FxAppConfig()
            return FxAppConfig(
