...
object DesktopComponent : KoinComponent {
    ...
    val contactService: dev.outerstellar.platform.service.ContactService by inject()
...
class SyncWindow(
    ...
    private fun configureFrame() {
        ...
        val notifListModel =
            javax.swing.DefaultListModel<dev.outerstellar.platform.model.NotificationSummary>()
        val notifList =
                ...
                cellRenderer =
                    object : javax.swing.DefaultListCellRenderer() {
                        override fun getListCellRendererComponent(
                            ...
                            val n =
                                value as? dev.outerstellar.platform.model.NotificationSummary
                                    ?: return this
    ...
    private fun showSettingsDialog() {
        ...
        fun updatePreview(theme: dev.outerstellar.platform.model.ThemeDefinition) {
