...
class SwingAppE2ETest {
    ...
    private fun assertThemeColors(
        w: FrameFixture,
        theme: dev.outerstellar.platform.model.ThemeDefinition,
    ) {
    ...
    private fun assertThemeDiffersFrom(
        w: FrameFixture,
        previous: dev.outerstellar.platform.model.ThemeDefinition,
        current: dev.outerstellar.platform.model.ThemeDefinition,
    ) {
